...
// Single source of truth for the context type using TypeScript inference
// This automatically stays in sync with what useAppManager actually returns
export type AppContextType = ReturnType<typeof import('../_hooks/useAppManager').useAppManager>;